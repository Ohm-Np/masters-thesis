...
1. with increase in the resolution and increase in number of polygons - terra zonal performs better in sequential mode.
2. many more to come
...
1. with increase in the resolution and increase in number of polygons - terra zonal performs better in sequential mode.
2. many more to come
3. processing big rasters result in crash of the server
...
1. using terra zonal in sequential mode
