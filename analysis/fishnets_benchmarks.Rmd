...
t5 <- read.csv("data/results/fishnet_benchmarks/time5.csv")
t10 <- read.csv("data/results/fishnet_benchmarks/time10.csv")
t25 <- read.csv("data/results/fishnet_benchmarks/time25.csv")
t50 <- read.csv("data/results/fishnet_benchmarks/time50.csv")
t100 <- read.csv("data/results/fishnet_benchmarks/time100.csv")

df.result <- data.frame(
  Functions = c("terra::extract", "terra::zonal", "exact_extract"),
  hexa_5 = c(t5[2][[1]], t5[3][[1]], t5[4][[1]]),
  hexa_10 = c(t10[2][[1]], t10[3][[1]], t10[4][[1]]),
  hexa_25 = c(t25[2][[1]], t25[3][[1]], t25[4][[1]]),
  hexa_50 = c(t50[2][[1]], t50[3][[1]], t50[4][[1]]),
  hexa_100 = c(t100[2][[1]], t100[3][[1]], t100[4][[1]])
)
...
t200 <- read.csv("data/results/fishnet_benchmarks/time200.csv")
t500 <- read.csv("data/results/fishnet_benchmarks/time500.csv")
t1000 <- read.csv("data/results/fishnet_benchmarks/time1000.csv")
t5000 <- read.csv("data/results/fishnet_benchmarks/time5000.csv")
t10000 <- read.csv("data/results/fishnet_benchmarks/time10000.csv")

df.result2 <- data.frame(
  Functions = c("terra::extract", "terra::zonal", "exact_extract"),
  hexa_200 = c(t200[2][[1]], t200[3][[1]], t200[4][[1]]),
  hexa_500 = c(t500[2][[1]], t500[3][[1]], t500[4][[1]]),
  hexa_1000 = c(t1000[2][[1]], t1000[3][[1]], t1000[4][[1]]),
  hexa_5000 = c(t5000[2][[1]], t5000[3][[1]], t5000[4][[1]]),
  hexa_10000 = c(t10000[2][[1]], t10000[3][[1]], t10000[4][[1]])
)
